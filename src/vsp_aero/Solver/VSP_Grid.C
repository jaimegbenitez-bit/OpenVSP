...
void VSP_GRID::CreateUpwindEdgeData(void)
{
    ...
    for ( j = 1 ; j <= NumberOfEdges() ; j++ ) {
       ...
       // Note that on VLM models some edges only have 1 tri... hence the checks below
...
/*##############################################################################
#                                                                              #
#                      VSP_GRID CalculateLoopNormals                           #
#                                                                              #
##############################################################################*/
/*
void VSP_GRID::CalculateLoopNormals(void) 
{    
...
/*##############################################################################
#                                                                              #
#                      VSP_GRID CalculateLeastSquareCoefficients               #
#                                                                              #
##############################################################################*/
/*
