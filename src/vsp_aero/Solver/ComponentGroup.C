...
void COMPONENT_GROUP::LoadData(FILE *File)
{
    ...
    // Version 7.x optional fields may appear here (before Mass) when the groups
    // file was generated by a newer tool that writes them in this position.
    // Handle them with fgetpos/fsetpos so legacy files (Mass right after Omega)
